...
//     rules: [
//       { token: "keyword", foreground: "00D9FF" },       // keywords cyan
//       { token: "type", foreground: "00FFA3" },          // types green
//       { token: "string", foreground: "FFB347" },        // strings orange
//       { token: "number", foreground: "00FFA3" },        // numbers neon
...
//     a.href = url;
//     a.download = `converted.${language?.toLowerCase() || "txt"}`;
//     a.click();
//   };
