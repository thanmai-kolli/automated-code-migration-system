from version_upgrade_system.languages.c.enterprise_engine.version_detector import CVersionDetector
from version_upgrade_system.languages.c.enterprise_engine.transformer import CTransformer
from version_upgrade_system.languages.c.enterprise_engine.memory_analyzer import CMemoryAnalyzer
from version_upgrade_system.languages.c.enterprise_engine.struct_modernizer import StructModernizer
from version_upgrade_system.languages.c.enterprise_engine.inline_optimizer import InlineOptimizer
from version_upgrade_system.languages.c.enterprise_engine.risk_analyzer import CRiskAnalyzer
from version_upgrade_system.languages.c.enterprise_engine.validator import CValidator
from version_upgrade_system.languages.c.enterprise_engine.diff_generator import DiffGenerator
from version_upgrade_system.languages.c.enterprise_engine.confidence_engine import CVersionConfidence
